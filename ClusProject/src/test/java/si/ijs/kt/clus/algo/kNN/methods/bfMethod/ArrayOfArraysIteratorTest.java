...
public class ArrayOfArraysIteratorTest extends BaseTestCase{
	...
	public void singletonTest() {
		...
		Pair<Integer[][], ArrayList<Integer>>[] pairs = new Pair[] {
	...
	public void mixedTest() {
		Integer[][] test1 = new Integer[][] {new Integer[] {}, new Integer[] {1}, new Integer[] {}, new Integer[] {3}};
		ArrayList<Integer> solution1 =  new ArrayList<Integer>(Arrays.asList(1, 3));
		Integer[][] test2 = new Integer[][] {new Integer[] {1}, new Integer[] {}, new Integer[] {3}, new Integer[] {}};
		ArrayList<Integer> solution2=  new ArrayList<Integer>(Arrays.asList(1, 3));
		Integer[][] test3 = new Integer[][] {new Integer[] {}, new Integer[] {1}, new Integer[] {3}, new Integer[] {}};
		ArrayList<Integer> solution3 =  new ArrayList<Integer>(Arrays.asList(1, 3));
		Integer[][] test4 = new Integer[][] {new Integer[] {1}, new Integer[] {}, new Integer[] {}, new Integer[] {3}};
		ArrayList<Integer> solution4 =  new ArrayList<Integer>(Arrays.asList(1, 3));
		Integer[][] test5 = new Integer[][] {new Integer[] {}, new Integer[] {1, 2, 3}, new Integer[] {}, new Integer[] {3}};
