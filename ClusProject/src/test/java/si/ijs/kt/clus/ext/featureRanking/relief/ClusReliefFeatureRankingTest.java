...
public class ClusReliefFeatureRankingTest extends BaseTestCase {
    ...
    public void computeReliefImportance() throws IOException {
        ...
        for (Pair<String, String> pair : settingsFimps) {
            ...
            assertEquals(fimpH1.size(), fimpH2.size(), String.format("Sizes of two headers do not match for .s file %s", sFile));
            ...
            assertEquals(contents1.size(), contents2.size(), String.format("Sizes of fimps' tables do not match for .s file %s", sFile));
