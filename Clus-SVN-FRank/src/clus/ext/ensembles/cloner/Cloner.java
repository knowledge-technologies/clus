...
public class Cloner {
    ...
    protected <T> T cloneInternal(final T o, final Map<Object, Object> clones) throws IllegalAccessException {
        ...
        if (clz.isArray()) { return cloneArray(o, clones); }
    ...
    /**
     * copies all properties from src to dest. Src and dest can be of different class, provided they contain same field
     * names/types
     *
     * @param src
     *        the source object
