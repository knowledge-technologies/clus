...
import si.ijs.kt.clus.ext.featureRanking.ensemble.ClusEnsembleFeatureRankingTest;
import si.ijs.kt.clus.ext.featureRanking.relief.ClusReliefFeatureRankingTest;
...
public class ClusFeatureRankingTest extends BaseTestCase {
	...
	private static String m_Subfolder = m_DataFolder + "/ensembleAndRankingData";
	private static HashSet<String> m_OldFiles;
	...
	public static void setOldFiles(HashSet<String> o){
		m_OldFiles = o;
	}
	...
	@Test
	public void computeImportance() throws IOException {
		
		for(int rankingType = 0; rankingType < 2; rankingType++) {
			ArrayList<Triple<String, String, String>> settFimpTrueFimpNew;
			String[] args;
			Pair<ArrayList<Triple<String, String, String>>, String[]> testDefinition;
			if (rankingType == 0) {
				testDefinition = ClusEnsembleFeatureRankingTest.generateNames();
			} else if (rankingType == 1) {
				testDefinition = ClusReliefFeatureRankingTest.generateNames();
			} else {
				testDefinition = null;
			}
			settFimpTrueFimpNew = testDefinition.getFirst();
			args = testDefinition.getSecond();
			for (Triple<String, String, String> triple : settFimpTrueFimpNew) {
				...
				Quadruple<String, String, String[], String[]> tableHeaderColumnBlocks2 = fimpComputed
				        .getTableHeaderColumnBlocks();
				Quadruple<String, String, String[], String[]> tableHeaderColumnBlocks1 = fimpTruth
				        .getTableHeaderColumnBlocks();
				String tmp1, tmp2;
				String[] tmps1, tmps2;
				...
				ArrayList<Quadruple<Integer, String, int[], double[]>> contents2 = fimpComputed
				        .getTableContentsColumnBlocks();
				ArrayList<Quadruple<Integer, String, int[], double[]>> contents1 = fimpTruth.getTableContentsColumnBlocks();
	...
	public static HashSet<String> currentFiles() {
