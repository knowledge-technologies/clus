...
public class FTest {
    ...
    protected final static double critical_f_01[] = { 39.8161, 8.5264, 5.5225, 4.5369, 4.0804, 3.7636, 3.61, 3.4596, 3.3489, 3.2761, 3.24, 3.1684, 3.1329, 3.0976, 3.0625, 3.0625, 3.0276, 2.9929, 2.9929, 2.9584 };

    protected final static double critical_f_005[] = { 161.0, 18.5, 10.1, 7.71, 6.61, 5.99, 5.59, 5.32, 5.12, 4.96, 4.84, 4.75, 4.67, 4.6, 4.54, 4.49, 4.45, 4.41, 4.38, 4.35, 4.32, 4.3, 4.28, 4.26, 4.24, 4.23, 4.21, 4.2, 4.18, 4.17 };

    protected final static double critical_f_001[] = { 4052.0, 98.5, 34.1, 21.2, 16.3, 13.7, 12.2, 11.3, 10.6, 10.0, 9.65, 9.33, 9.07, 8.86, 8.68, 8.53, 8.40, 8.29, 8.18, 8.1, 8.02, 7.95, 7.88, 7.82, 7.77, 7.72, 7.68, 7.64, 7.6, 7.56 };

    // for 0.005: derived from t-table, squared values (=> approximate!)
    protected final static double critical_f_0005[] = { 15876, 198.81, 55.5025, 31.36, 22.7529, 18.6624, 16.2409, 14.6689, 13.6161, 12.8164, 12.25, 11.7649, 11.2896, 11.0889, 10.8241, 10.5625, 10.3684, 10.24, 10.0489, 9.9225, 9.8596, 9.7344, 9.61, 9.5481, 9.4864, 9.4249, 9.3636, 9.3025, 9.2416, 9.1809 };
    ...
    public static double getCriticalFCommonsMath(double sig, double df) {
        ...
        return new FDistribution(1, df).inverseCumulativeProbability(1 - sig);
