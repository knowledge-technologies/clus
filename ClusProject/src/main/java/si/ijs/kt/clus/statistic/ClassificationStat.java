            ...
            if (NeighCount > 0) {
                ...
                for (int i = M; i < N; i++) {
                    ...
                    for (int j = M; j < NN; j++) {
                        ...
                        upsum[k] += w[permutation[i]][permutation[j]] * (ti - means[k]) * (distances[j].target - means[k]); // m_distances.get(permutation[i]*N+permutation[j])
            ...
            if (NeighCount > 0) {
                ...
                for (int i = M; i < N; i++) {
                    ...
                    while ((distances.length > j) && (distances[j] != null) && j < NeighCount) {
                        ...
                        upsumR[k] += w[permutation[i]][permutation[j]] * (ti - meansR[k]) * (distances[j].target - meansR[k]); // m_distances.get(permutation[i]*N+permutation[j])
                                                                                                                               // [permutation[i]][permutation[j]]
