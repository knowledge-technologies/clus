...
\begin{itemize}
    ...
    \begin{itemize}
        \item \optionPossibleValues{}: an element of \optionPossibleValuesList{euclidean,manhattan,chebyshev}
    ...
    \begin{itemize}
        \item \optionPossibleValues{}: an element of \optionPossibleValuesList{BruteForce, VP-tree, KD-tree}
    ...
    \begin{itemize}
        \item \optionPossibleValues{}: an element of \optionPossibleValuesList{constant,1-d,1/d}
        ...
        is equivalent to no weighting, whereas the options \formatOneElement{1-d} and \formatOneElement{1/d} respectively correspond to the weights that equal
