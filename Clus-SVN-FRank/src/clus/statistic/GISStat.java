...
public GISStat(NumericAttrType[] attrs) {
    this(attrs, false);
}

public GISStat(NumericAttrType[] attrs, boolean onlymean) {
...
public ClusStatistic cloneStat() {
    GISStat res = new GISStat(m_Attrs, false);
...
public ClusStatistic cloneSimple() {
    GISStat res = new GISStat(m_Attrs, true);
    res.m_Training = m_Training;
    res.m_NbTarget = m_NbTarget;
    return res;
}
