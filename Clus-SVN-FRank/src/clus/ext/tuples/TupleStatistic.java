...
public class TupleStatistic extends SumPairwiseDistancesStat {
	...
	private ArrayList m_TupleStack = new ArrayList();
	public Tuple m_RepresentativeMean = new Tuple("[]");
	public Tuple m_RepresentativeMedoid = new Tuple("[]");
	private ClusDistance[] distances;

	// public Tuple m_RepresentativeQuantitve=new Tuple("[]");

	protected double m_AvgDistances;

	public TupleStatistic(TupleAttrType attr, ClusDistance dist, int efflvl) {
		super(dist, efflvl);
		m_Attr = attr;
	}

	public ClusStatistic cloneStat() {
		TupleStatistic stat = new TupleStatistic(m_Attr, m_Distance, m_Efficiency);
		stat.cloneFrom(this);
		return stat;
	}
