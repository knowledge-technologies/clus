...
package si.ijs.kt.clus.util.jeans.graph.tree;
...
import si.ijs.kt.clus.util.jeans.graph.swing.drawable.Drawable;
import si.ijs.kt.clus.util.jeans.graph.swing.drawable.DrawableCanvas;
import si.ijs.kt.clus.util.jeans.graph.swing.drawable.DrawableExpandButton;
import si.ijs.kt.clus.util.jeans.graph.swing.drawable.DrawableRectangle;
import si.ijs.kt.clus.util.jeans.graph.swing.drawable.DrawableRenderer;
import si.ijs.kt.clus.util.jeans.tree.IntervalTreeNodeRB;
import si.ijs.kt.clus.util.jeans.tree.IntervalTreeRB;
import si.ijs.kt.clus.util.jeans.util.Executer;
...
public class TreeRenderer implements DrawableRenderer {
    ...
    public class Renderer {
        ...
        private void moveTop(MyDrawableNode node, int gap) {
            ...
            int xpos = getX(pdr);
            if (xpos < gap)
                moveNodeRecursive(node, gap - xpos);
        }
