...
public abstract class ClusModelInfoList implements Serializable {
    ...
    /**
     * @param i
     *        Usually ClusModel model type (Default, Original, Pruned).
     ...
     *        Usually ClusModel model type (Default, Original, Pruned).
     * @param j
     *        If model "i" does not exist, return model "j".
    ...
    public ClusModelInfo initModelInfo(int i) {
        ...
        if (i == ClusModel.DEFAULT)
            name = "Default";
        if (i == ClusModel.ORIGINAL)
            name = "Original";
        if (i == ClusModel.PRUNED)
            name = "Pruned";
    ...
    public void initEnsemblePredictionsWriter(int type) {
        ClusModelInfo mi = getModelInfo(ClusModel.ORIGINAL); // for ensembles we consider only the original at thsi
                                                             // point
