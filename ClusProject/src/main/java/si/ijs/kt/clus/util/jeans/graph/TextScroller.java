...
import si.ijs.kt.clus.util.jeans.graph.drawable.Drawable;
import si.ijs.kt.clus.util.jeans.graph.drawable.DrawableImage;
import si.ijs.kt.clus.util.jeans.graph.drawable.DrawableLine;
import si.ijs.kt.clus.util.jeans.graph.drawable.DrawableProvider;
        ...
        do {
            if (tokens.isNextToken(":")) {
                ...
                if (token.equals("FONT"))
                    setFont(tokens);
                if (token.equals("XTAB"))
                    xp += setTab(tokens);
                if (token.equals("YTAB"))
                    yp += setTab(tokens);
