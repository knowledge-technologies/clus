 ...
 * Implemented on the basis of: Culp and Michailidis, An iterative algorithm for extending learners to a semi-supervised setting, Journal of Computational and Graphical Statistics, 2008 
 * @author jurical
 */
    ...
    public ClusModel induceSingleUnpruned(ClusRun cr) throws ClusException, IOException, InterruptedException {
        ...
        while (iterations <= m_Iterations && deltaUnlabeled > m_Threshold) {
            ...
            if (first) {
                ...
                writer = new PrintWriter(cr.getStatManager().getSettings().getAppName() + "_SelfTrainingFTFErrors.csv", "UTF-8");
