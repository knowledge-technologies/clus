...
/**
 * @author tstepi
 *         Mean Squared Error (MSE) for regression, with bias-variance decomposition. Not to use for multi-target
 *         regression.
 */
public class MSEBiasVar extends ClusNumericError {
    ...
    public String getName() {
        if (m_Weights == null)
            return "Mean squared error (MSE) with bias-variance decomposition";
        else
