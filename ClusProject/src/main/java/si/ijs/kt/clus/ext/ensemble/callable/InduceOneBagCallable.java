...
public class InduceOneBagCallable implements Callable<OneBagResults> {
    ...
    public InduceOneBagCallable(ClusEnsembleInduce cei, ClusRun cr, int i, int origMaxDepth, OOBSelection oob_sel, TupleIterator train_iterator, TupleIterator test_iterator, BaggingSelection msel, ClusRandomNonstatic rnd, ClusStatManager mgr) {
        this.m_Cei = cei;
        this.m_Cr = cr;
        this.m_I = i;
    ...
    public OneBagResults call() throws Exception {
        ...
        return m_Cei.induceOneBag(m_Cr, m_I, m_OrigMaxDepth, m_Oob_sel, m_Train_iterator, m_Test_iterator, m_Msel, m_Rnd, m_Mgr);
    }
