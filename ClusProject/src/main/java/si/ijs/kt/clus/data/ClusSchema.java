...
public class ClusSchema implements Serializable {
    ...
    protected void addRowsIndex() {
        ...
        for (AttributeUseType attruse : AttributeUseType.values()) {
            ...
            m_NominalAttrUse[attruse.getIndex()] = vectorToNominalAttrArray(collectAttributes(attruse, AttributeType.Nominal));
            m_NumericAttrUse[attruse.getIndex()] = vectorToNumericAttrArray(collectAttributes(attruse, AttributeType.Numeric));
            m_TimeSeriesAttrUse[attruse.getIndex()] = vectorToTimeSeriesAttrArray(collectAttributes(attruse, AttributeType.TimeSeries));
        }
    }
