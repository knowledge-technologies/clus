...
public abstract class MyNodePainter extends Drawable {
    ...
    public Color getNodeColor() {
        if (m_Node.atBottomLevel())
            return m_Node.getPaintSettings().LEAF_COLOR;
        else
            return m_Node.getPaintSettings().NODE_COLOR;
    }


    public Color getBorderColor() {
        if (m_Node.atBottomLevel())
            return m_Node.getPaintSettings().LEAF_BORDER_COLOR;
        else
            return m_Node.getPaintSettings().NODE_BORDER_COLOR;
    }
